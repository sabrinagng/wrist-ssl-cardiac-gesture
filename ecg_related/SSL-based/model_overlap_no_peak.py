"""
model_overlap_no_peak.py
ECG MAE with patch overlap and random masking only (no peak detection).
"""
import math
...
class ECGMAE(nn.Module):
    """MAE for 1D multi-channel ECG. Input: [B, C, L]."""
    ...
    def random_masking(x, mask_ratio):
        """Random masking. Returns: x_masked, mask, ids_restore."""
        B, N, D = x.shape
...
def build_model_for_dataset(
    ...
    """Build ECGMAE model with patch overlap and random masking."""
